                                                ...
                                                <tbody>
                                                    <tr class="unread">
                                                        <td><img class="rounded-circle" style="width:40px;"
                                                                src="<?php echo base_url()?>admin_assets/images/user/avatar-1.jpg"
                                                    ...
                                                    <tr class="unread">
                                                        <td><img class="rounded-circle" style="width:40px;"
                                                                src="<?php echo base_url()?>admin_assets/images/user/avatar-2.jpg"
                                                                alt="activity-user"></td>
                                                        <td>
                                                    ...
                                                    <tr class="unread">
                                                        <td><img class="rounded-circle" style="width:40px;"
                                                                src="<?php echo base_url()?>admin_assets/images/user/avatar-3.jpg"
                                                                alt="activity-user"></td>
                                                        <td>
