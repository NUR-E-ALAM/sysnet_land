            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <?php
                        echo form_input(array('name' => 'email', 'class' => 'form-control', 'placeholder' => 'Email', 'id' => 'email', 'value' => set_value('email', ''), 'maxlength' => '100'));
                    ...
                    <div class="input-group mb-4">
                        ...
                        <?php
                        echo form_password(array('name' => 'password', 'class' => 'form-control', 'placeholder' => 'Password', 'id' => 'password', 'value' => set_value('password', ''), 'maxlength' => '100'));
                        ?>
                    ...
                    <input type="submit" name="login" class="btn btn-primary shadow-2 mb-4" value="Login Me" />
                    <?php echo form_close(); ?>
                    <p class="mb-2 text-muted">Forgot password? <a href="auth-reset-password.html">Reset</a></p>
                    <p class="mb-0 text-muted">Don’t have an account? <a
                            href="<?php base_url(); ?>Signup/registration">Signup</a></p>
                </div>
            </div>
        </div>
    </div>
